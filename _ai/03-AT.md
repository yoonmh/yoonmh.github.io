...
* [Inception Model Architecture][c1-w1-r3]
...
6. Siamese network ([Video][c1-w1-v6], [R1][c1-w1-r6], [R2][c1-w1-r7])
7. Multi-Input Siamese network 코딩 ([Video][c1-w1-v7])
8. Siamese network 코딩 ([Video][c1-w1-v8])

### W-2. Custom Loss Functions
1. Custom loss tunction 생성 ([Video][c1-w2-v1])
2. Huber loss function ([Video][c1-w2-v2])
3. Huber loss 코딩 ([Video][c1-w2-v3])
4. Custom loss hyperparameter ([Video][c1-w2-v4])
5. Turning loss functions into classes ([Video][c1-w2-v5])
6. Huber Object Loss 코딩 ([Video][c1-w2-v6])
7. Contrastive Loss ([Video][c1-w2-v7]) 
8. Contrastive Loss 코딩 ([Video][c1-w2-v8])
...
[c1-w1-r6]: https://drive.google.com/file/d/1XyhF3XYGtCPt_cSF7YsYd6iwtzAKVOye/view?usp=sharing
[c1-w1-r7]: https://drive.google.com/file/d/1XnnzbecmtndFFgkPkV8bxgR9YgMzPzgt/view?usp=sharing
