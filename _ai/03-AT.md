...
5. Encoder in Code ([Video][c3-w3-v5], [CamVid][s3-w3-r5])
6. Decoder in Code ([Video][c3-w3-v6])
7. Evaluation with IoU and Dice Score ([Video][c3-w3-v7], [Notebook][c3-w3-n7])
8. U-Net Overview ([Video][c3-w3-v8], [U-Net][s3-w3-r8])
9. U-Net Code: Encoder ([Video][c3-w3-v9], [Notebook][s3-w3-n9])
10. U-Net Code: Decoder ([Video][c3-w3-v10])
11. Instance Segmentation ([Video][c3-w3-v11], [Notebook][s3-w3-n11])
...
6. Train the VAE Model ([Video][c4-w3-v6], [Nptebook][c4-w3-n6], [Ref][c4-w3-r6])
