...
* [원서](https://drive.google.com/file/d/1BLCtipM6ja_gQ9zoxODXTK0xoJ6WRp8m/view?usp=sharing)
...
* 7장 앙상블 학습과 랜덤 포레스트 ([pdf][p7-1])
  * [7장(1)][y7-1], [7장(2)][y7-2]
  * [투표 기반 분류기][7-1], [Random Forest][7-2], [Boosting][7-3], [연습문제][7-4]
* 8장 차원 축소 ([pdf][p8-1])
  * [8장(1)][y8-1]
...
* 18장 강화 학습 ([pdf-1][p18-1], [pdf-2][p18-2])
  * [강화 학습][18-1], [DGN][18-2], [TF-Agents][18-3], [연습문제][18-4]
* 19장 대규모 텐서플로 모델 훈련과 배포 
  * [모델 배포][19-1], [연습문제][19-4]
...
[18-2]: https://colab.research.google.com/drive/1jbmGxs015BbiWYbY5tir7iip74EDzJsK
[18-3]: https://colab.research.google.com/drive/1jgBKMn6dnQaAmJbPY8yyqTAV2S8WYzT2
