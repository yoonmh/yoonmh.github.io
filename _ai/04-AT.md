...
* Gradient Tape ([Video][c2-w1-v7])
  ...
  * Gradient Tape basics code ([Video][c2-w1-v11], [Notebook][c2-w1-n11])
...
* Trasfer Learning
  ...
  * Options in Transfer Learning ([Video][c3-w1-v5])
  * [Transfer Learning Lab][c3-w1-n5]
...
### (1) Style Transfer
* [Lecture Notes][c4-w1]
* Style Transfer Intro ([Video][c4-w1-v1])
  * [A Neural Algorithm of Aartistic Dstyle][c4-w1-r1])
  * Style Transfer Conceptual Overview ([Video][c4-w1-v2], [Ref][c4-w1-r2])
  * Pre-Processing Inputs ([Video][c4-w1-v3])
  * Extracting Style and Content Features ([Video][c4-w1-v4])
  * Total Loss and Content Loss ([Video][c4-w1-v5])
  * Style Loss ([Video][c4-w1-v6], [Ref][c4-w1-r6])
...
* Variational AutoEncoders
  ...
  * References: [R1][c4-w3-r51], [R1][c4-w3-r52]
  * Train the VAE Model ([Video][c4-w3-v6], [Notebook][c4-w3-n6], [Ref][c4-w3-r6])
...
* What are GANs?
  ...
  * First GAN Training Loop ([Video][c4-w4-v3], [Ref][c4-w4-n3])
* Deep GANs
