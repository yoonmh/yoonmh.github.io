...
* [Lecture Notes][c1-w1]
* Functional APIs
  * Introduction to Functional APIs ([Video][c1-w1-v1], [Practise][c1-w1-n1])
...
* Creating Multi-Output Architecture
  * Creating a Multi-Output Model ([Video][c1-w1-v4])
  * [Energy Efficiency Dataset][c1-w1-r4])
...
* Siamese network
  ...
  * Coding a Multi-Input Siamese network 코딩 ([Video][c1-w1-v7], [Vector Distance][c1-w1-r7])
...
* Custom loss functions
  * Creating a custom loss tunction 생성 ([Video][c1-w2-v1], [Huber Loss][c1-w2-r1])
