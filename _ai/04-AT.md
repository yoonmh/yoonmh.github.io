...
* Creating Multi-Output Architecture
  ...
  * Multi-Output code ([Video][c1-w1-v5])
  * [Multi-output Lab][c1-w1-n5]
* Siamese network
  ...
  * Siamese network code ([Video][c1-w1-v8])
  * [Siamese Network Lab][c1-w1-n8]
...
* Custom loss functions
  ...
  * Huber loss code ([Video][c1-w2-v3])
  * [Huber loss lab][c1-w2-n3]
* Custom loss hyperparameters and classes
  ...
  * Huber Object Loss code ([Video][c1-w2-v6])
  * [Huber Loss object][c1-w2-n6]
* Contrastive Loss
  * Contrastive Loss ([Video][c1-w2-v7])
  * [Dimentionality Reduction by learning an invariant mapping][c1-w2-r7]
  * Coding Contrastive Loss ([Video][c1-w2-v8])
  * [Contrastive Loss i Siamese network][c1-w1-n8])
...
* Custom lambda layers
  ...
  * Exploring custom ReLU with Lambda Layers ([Video][c1-w3-v3])
  * [Lambda Layers Lab][c1-w3-n3])
* Implementing Custom Layers
  * Architecture of a Custom Layer ([Video][c1-w3-v4])
  * Coding your own custom Dense Layer ([Video][c1-w3-v5])
  * Training a neural network with your Custo Layer ([Video][c1-w3-v6])
  * Custom Layer code ([Video][c1-w3-v7])
  * [Custom Dense Layer Lab][c1-w3-n7])
* Activating Custom Layers
  * Activating your Custom Layer ([Video][c1-w3-v8])
  * Custo Layer with activation code ([Video][c1-w3-v9])
  * [Activation in custom layer lab][c1-w3-n9])
* Assignment: [Custom Layers][c1-w3-hw]

### (4) Custom Models
* [Lecture Notes][c1-w3]
* Complex Architectures with the Functional API ([Video][c1-w4-v1])
  * Coding a Wide eand Deep model ([Video][c1-w4-v2])
  * [Build a Basic Model][c1-w4-n2]
* Using th Model class to simplyfy complex architectures ([Video][c1-w4-v3])
...
* Implementing ResNet
  ...
  * ResNet code ([Video][c1-w4-v6])
  * [Build a ResNet model][c1-w4-n6])
* Assignment: [Custom Models][c1-w4-hw]

### (5) Callbacks
* [Lecture Notes][c1-w3]
* Built-in Callbacks ([Video][c1-w5-v1])
  * [TensorBoard Visualization toolkit][c1-w5-t1])
  * [Built-in Callbacks][c1-w5-n1])
* Custom Callbacks ([Video][c1-w5-v2])
  * Custom Callbacks code ([Video][c1-w5-v2])
  * [Custom Callbacks][c1-w5-n3])
...
* Tensor Basics
  ...
  * Basic Tensors code ([Video][c2-w1-v4])
  * [Basic Tensors Lab][c2-w1-n4]
...
* Gradient Tape ([Video][c2-w1-v7])
  ...
  * Gradient Tape basics code ([Video][c2-w1-v11])
  * [Gradient Tape Basics Lab][c2-w1-n11]
...
* Custom Training Loops
  ...
  * Training Basics code ([Video][c2-w2-v4])
  * [Training Basics Lab][c2-w2-n4]
* Custom Traing with TensorFlow Datasets
  ...
  * Fashion MNIST Custom Training Loop code ([Video][c2-w2-v8])
  * [Fashion MNIST using Custom Training Loop][c2-w2-n8]
...
* AutoGraph
  ...
  * Generating Graph code ([Video][c2-w3-v2])
  * [Fizz Buz][c2-w3-r2]
  * AutoGraph Basics code ([Video][c2-w3-v3])
  * [AutoGraph Basics Lab][c2-w3-n3]
* Creating Graphs for Complex Code
  * Control dependencies and flows ([Video][c2-w3-v4])
  * Loops and tracing variables ([Video][c2-w3-v5])
  * AutoGraph code ([Video][c2-w3-v6])
  * [AutoGraph Lab][c2-w3-n6])
...
* Mirrored Strategy
  ...
  * Mirrored Strategy code ([Video][c2-w4-v4])
  * [Mirrored Strategy Lab][c2-w4-n4]
* Multiple GPU Mirrored Strategy
  * Custom Training for Multiple GPU Mirrored Strategy ([Video][c2-w4-v5])
  * Multi GPU Mirrored Strategy code ([Video][c2-w4-v6])
  * [Multi GPU Mirrored Strategy Lab][c2-w4-n6]
